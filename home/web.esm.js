...
var $;
(function ($) {
    class $pocket_home extends $mol_view {
        sub() {
            return [
                this.page()
            ];
        ...
        Content() {
            ...
            obj.event_click = (val) => this.openWeather();
            obj.sub = () => [
                this.City(),
                this.Temp()
            ];
        ...
        Week() {
            const obj = new this.$.$mol_text();
            obj.text = () => this.calculateWeek();
            return obj;
        }
        PoweredBy() {
            const obj = new this.$.$mol_text();
            obj.text = () => "powered by @koplenov";
            return obj;
        }
        page() {
            const obj = new this.$.$mol_list();
    ...
    __decorate([
        $mol_mem
    ], $pocket_home.prototype, "Today", null);
    __decorate([
        $mol_mem
    ], $pocket_home.prototype, "City", null);
    __decorate([
        $mol_mem
    ], $pocket_home.prototype, "Temp", null);
    __decorate([
        $mol_mem
    ], $pocket_home.prototype, "Content", null);
    __decorate([
        $mol_mem
    ], $pocket_home.prototype, "Weather", null);
    __decorate([
        $mol_mem
    ], $pocket_home.prototype, "Week", null);
    __decorate([
        $mol_mem
    ], $pocket_home.prototype, "PoweredBy", null);
    __decorate([
        $mol_mem
    ], $pocket_home.prototype, "page", null);
    $.$pocket_home = $pocket_home;
})($ || ($ = {}));
//pocket/home/-view.tree/home.view.tree.ts
;
"use strict";
var $;
(function ($) {
...
var $;
(function ($) {
    $mol_style_attach("pocket/home/home.view.css", "[pocket_home]{\n  width:100%;\n  max-width:100%;\n  font-family: 'Roboto', sans-serif;\n  overflow: hidden;\n  background: #1810107d;\n  backdrop-filter: blur(5px);\n}\n\n[pocket_home_city]{\n  font-size: 1.5rem;\n  font-weight: bold;\n  text-transform: uppercase;\n  color: rgba(207, 207, 207, 0.616);\n}\n\n[pocket_home_temp]{\n\tmargin-top: -1rem;\n\twidth:60%;\n\tfont-size: 3rem;\n\tfont-weight: bold;\n\tcolor: rgba(213, 213, 213, 0.9);\n\tfont-weight: 100;\n\talign-items: flex-end;\n}\n[pocket_home_week]{\n\tmargin-top: -1rem;\n\tcolor: rgba(213, 213, 213, 0.9);\n}\n\n[pocket_home_today]{\n\tcolor: rgba(213, 213, 213, 0.502);\n\theight: 1.7rem;\n}\n\n[pocket_home_poweredby]{\n\tmargin-top: -1rem;\n\tcolor: rgba(213, 213, 213, 0.502);\n}\n\n[pocket_home_weather]{\n\tmargin-top: -2.5rem;\n\tcolor: rgba(213, 213, 213, 0.502);\n}\n");
})($ || ($ = {}));
//pocket/home/-css/home.view.css.ts
;
"use strict";
var $;
(function ($) {
    ...
    (function ($$) {
        ...
        class $pocket_home extends $.$pocket_home {
            loadData() {
                return this.$.$mol_fetch.json(wttrUrlBase);
            }
            loadWeek() {
                return this.$.$mol_fetch.json(weekUrlBase);
            }
            openWeather() {
        ...
        __decorate([
            $mol_mem
        ], $pocket_home.prototype, "loadData", null);
        __decorate([
            $mol_mem
        ], $pocket_home.prototype, "loadWeek", null);
        $$.$pocket_home = $pocket_home;
    })($$ = $.$$ || ($.$$ = {}));
})($ || ($ = {}));
//pocket/home/home.view.ts
;
export default $
